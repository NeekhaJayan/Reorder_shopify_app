...
<body>
  ...
  <div class="Polaris-Text--root Polaris-Text--bodyMd Polaris-Text--block Polaris-Text--center" style="color: #434b56;">
    Order Fulfilled Date + (Ordered Quantity × <u>${reorder_days})</u><sup style="font-size: 7px;">(Estimated Usage Days)</sup> − <u>${buffer_Time}</u><sup style="font-size: 7px;">(Buffer Time)</sup>
  </div>
  </div>
</body>
</html>
